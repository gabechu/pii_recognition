...
from recognisers.letter_case import LetterCase
from tokeniser.detokeniser import space_join_detokensier
from tokeniser.tokeniser import nltk_word_tokenizer
from utils import write_iterable_to_text

from .manage_experiments import LETTER_CASE_EXP

RUN_NAME = "start_with_upper"

recogniser = LetterCase(supported_languages=["en"], tokeniser=nltk_word_tokenizer)
...
# Log to mlflow
mlflow.set_experiment(LETTER_CASE_EXP)
with mlflow.start_run(run_name=RUN_NAME):
    evaluator = ModelEvaluator(recogniser, ["PER"], nltk_word_tokenizer, to_eval_labels={"PER": "I-PER"})
