...
def map_labels(type_A_labels: List[str], A2B_mapping: Dict[str, str]) -> List[str]:
    """
    Convert between label conventions. For example, in one convention entity labels
    are defined as [PER, LOC], while in another labels could be defined as
    [PERSON, LOCATION]. This function bridges the conversion.
    """
...
def mask_labels(
    ...
    Args:
        ...
        keep_labels: labels don't want to be masked out.
